		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3">
						...
						<div class="buy-guide">
							...
							<ul>
								<li>Mua hàng trực tiếp tại website <b class="ng-binding">
										http://www.ABCXYZ.vn</b>
								</li>
								<li>Gọi điện thoại <strong class="ng-binding">
										0905 259 311 </strong> để mua hàng
								</li>
								<li>Mua tại Trung tâm CSKH:<br> <strong
									class="ng-binding">36 Nguyễn Chánh, Liên Chiểu, Đà Nẵng
										</strong> <a href="/ban-do.html" rel="nofollow" target="_blank">Xem
										Bản Đồ</a>
								</li>
								<li>Mua sỉ/buôn xin gọi <strong class="ng-binding">
										0706 156 133 </strong> để được hỗ trợ.
								</li>
							</ul>
						</div>
					</div>
					...
					<script type="text/javascript">
						window.Shop = {
							"Name" : "CÔNG TY TNHH TỰ PHÁT ĐÀ NẴNG",
							"Email" : "",
							"Phone" : "",
							"Logo" : "",
							"Fax" : "",
